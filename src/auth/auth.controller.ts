...
export class AuthController {
  ...
  async changePasswordbyToken(@Param('token') token: string, @Body() changePasswordDto: ChangePasswordDto) {
    return await this.authService.changePasswordbyToken(token, changePasswordDto);
  }
